...
Worm::NameDB - interface to biological name tracking database
...
=head1 SYNOPSIS
  ...
  my $db = Worm::NameDB->connect('name_test','lstein',undef);
...
=item $db = Worm::NameDB->connect($dsn [,$name,$password])
...
Returns a Worm::NameDB object if successful.
...
Here's how to create an empty database:
 ...
 % perl -MWorm::NameDB -e "Worm::NameDB->connect('name_test','username','passwd')->initialize(1)"
